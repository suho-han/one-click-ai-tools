...
현재 작업 기준 위치(2026-06-15 이후):
- **주 macOS 작업 호스트:** `suhohan@100.73.225.85`
- **주 작업 트리:** `/Users/suhohan/Projects/one-click-tools`
- `100.114.89.25` macmini는 과거 원격 검증 기록 보관/보조 검증 용도로만 유지한다.
